<template>
  <header class="bg-transparent z-30 sticky lg:static top-0 border-b">
    <div class="max-w-[1248px] w-fll mx-auto">
      <div
        class="md:flex hidden justify-between items-center lg:container px-4 lg:px-0 mx-auto py-6"
      >
